using AbpMudTheme.MvcDemo.Data;
using AbpMudTheme.MvcDemo.HealthChecks;
using AbpMudTheme.MvcDemo.Localization;
using AbpMudTheme.MvcDemo.Menus;
using AbpMudTheme.MvcDemo.Permissions;
...
public class MvcDemoModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.Conventions.AuthorizePage("/Books/Index", MvcDemoPermissions.Books.Default);
            options.Conventions.AuthorizePage("/Books/CreateModal", MvcDemoPermissions.Books.Create);
            options.Conventions.AuthorizePage("/Books/EditModal", MvcDemoPermissions.Books.Edit);
        });
    }

    private void ConfigureHealthChecks(ServiceConfigurationContext context)
    {
        context.Services.AddMvcDemoHealthChecks();
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<MvcDemoModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<MvcDemoModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(MvcDemoModule).Assembly);
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services)
    {
        services.AddAbpSwaggerGen(
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "MvcDemo API", Version = "v1" });
    ...
    private void ConfigureNavigationServices()
    {
        ...
        {
            options.MenuContributors.Add(new MvcDemoMenuContributor());
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new MvcDemoToolbarContributor());
        });
    }

    private void ConfigureEfCore(ServiceConfigurationContext context)
    {
        context.Services.AddAbpDbContext<MvcDemoDbContext>(options =>
        {
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "MvcDemo API");
        });
