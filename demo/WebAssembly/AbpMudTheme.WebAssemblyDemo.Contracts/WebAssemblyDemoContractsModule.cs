...
public class WebAssemblyDemoContractsModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<WebAssemblyDemoContractsModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<WebAssemblyDemoResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource), typeof(AbpUiResource))
                .AddVirtualJson("/Localization/WebAssemblyDemo");

            options.DefaultResourceType = typeof(WebAssemblyDemoResource);
        ...
        {
            options.MapCodeNamespace("WebAssemblyDemo", typeof(WebAssemblyDemoResource));
        });
    }
}
