...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Blazor Client
        var consoleAndBlazorClientId = configurationSection["WebAssemblyDemo_Blazor:ClientId"];
        if (!consoleAndBlazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["WebAssemblyDemo_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["WebAssemblyDemo_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["WebAssemblyDemo_Swagger:RootUrl"]?.TrimEnd('/');
