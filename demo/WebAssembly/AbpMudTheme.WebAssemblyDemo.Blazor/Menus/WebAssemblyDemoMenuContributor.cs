...
using AbpMudTheme.WebAssemblyDemo.Permissions;
...
namespace AbpMudTheme.WebAssemblyDemo.Menus;

public class WebAssemblyDemoMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public WebAssemblyDemoMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<WebAssemblyDemoResource>();

        context.Menu.AddItem(new ApplicationMenuItem(
            WebAssemblyDemoMenus.Home,
            l["Menu:Home"],
            "/",
            icon: "fas fa-home",
            order: 1
        ...
        */
        ...
        if (await context.IsGrantedAsync(WebAssemblyDemoPermissions.Books.Default))
        {
