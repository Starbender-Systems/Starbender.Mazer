...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 5311caeb-4c3b-43ce-8d88-500f0599366b
```

> `5311caeb-4c3b-43ce-8d88-500f0599366b` is the password of the certificate, you can change it to any password you want.
