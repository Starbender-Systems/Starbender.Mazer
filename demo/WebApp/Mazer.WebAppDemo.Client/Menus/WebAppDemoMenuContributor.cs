...
using Mazer.WebAppDemo.Permissions;
...
namespace Mazer.WebAppDemo.Menus;

public class WebAppDemoMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public WebAppDemoMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<WebAppDemoResource>();

        context.Menu.AddItem(new ApplicationMenuItem(
            WebAppDemoMenus.Home,
            l["Menu:Home"],
            "/",
            icon: "fas fa-home",
            order: 1
        ...
        */
        ...
        if (await context.IsGrantedAsync(WebAppDemoPermissions.Books.Default))
        {
