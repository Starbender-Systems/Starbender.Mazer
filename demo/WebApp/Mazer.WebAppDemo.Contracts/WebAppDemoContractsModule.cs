...
public class WebAppDemoContractsModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<WebAppDemoContractsModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<WebAppDemoResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource), typeof(AbpUiResource))
                .AddVirtualJson("/Localization/WebAppDemo");

            options.DefaultResourceType = typeof(WebAppDemoResource);
        ...
        {
            options.MapCodeNamespace("WebAppDemo", typeof(WebAppDemoResource));
        });
    }
}
